...
//TODO: $cordovaPush service need to be integrated in to the app.
angular.module('starter.services').factory('$cordovaPush',
		[ '$q', '$window', '$rootScope', '$timeout', function($q, $window, $rootScope, $timeout) {
